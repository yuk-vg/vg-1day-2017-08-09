...
import (
	...
	"github.com/yuk-vg/vg-1day-2017-08-09/kaji/bot"
	"github.com/yuk-vg/vg-1day-2017-08-09/kaji/controller"
	"github.com/yuk-vg/vg-1day-2017-08-09/kaji/db"
...
func (s *Server) Init(dbconf, env string) error {
	...
	// tutorial. 自己紹介を追加する
	// ...
	s.Engine.GET("/kaji", func(c *gin.Context) {
		c.HTML(http.StatusOK, "kaji.html", gin.H{})
	})
