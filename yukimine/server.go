...
import (
	...
	"github.com/yuk-vg/vg-1day-2017-08-09/yukimine/bot"
	"github.com/yuk-vg/vg-1day-2017-08-09/yukimine/controller"
	"github.com/yuk-vg/vg-1day-2017-08-09/yukimine/db"
...
func (s *Server) Init(dbconf, env string) error {
	...
	s.Engine.GET("/yukimine", func(c *gin.Context) {
		c.HTML(http.StatusOK, "yukimine.html", gin.H{})
	})
